...
KERNEL		= kernel.bin
OBJS		= kernel/kernel.o kernel/start.o kernel/interrupt.o lib/lib.o lib/libc.o kernel/clock.o kernel/main.o kernel/global.o kernel/syscall.o kernel/tty.o
